...
# 00_neural_networks documentation build
...
from 00_neural_networks import __version__ as release

# -- Project information -----------------------------------------------------

project = "00_neural_networks"
author = "Kedro"
...
htmlhelp_basename = "00_neural_networksdoc"
...
latex_documents = [
    (
        master_doc,
        "00_neural_networks.tex",
        "00_neural_networks Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "00_neural_networks",
        "Project 00_neural_networks codebase.",
        "Data-Science",
    )
]
